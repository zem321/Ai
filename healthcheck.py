...
плюс подтягивание статусов мониторов UptimeRobot.

Не участвует в обычном пользовательском пути запроса — это отдельный
диагностический прогон по команде /healthcheck или по расписанию.
"""
